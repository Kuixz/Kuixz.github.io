...
const plat = setAttributes(document.createElement("div"), { class:"platform", parent:frame })
// plat.style.backgroundImage = "url('assets/platform2.png')"
setAttributes(document.createElement("img"), { src:"assets/platform_top.png", class:"platsprite", parent:plat })
const hoverCenter = setAttributes(document.createElement("div"), { class:"hover-center", parent: plat })
setAttributes(document.createElement("img"), { src:"assets/platform_bottom.png", class:"platsprite", parent:plat })